            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body" style="padding-bottom: 100px;">
                        ...
                        <?php } ?>
                        <p>
                            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#barchart"
                                    aria-expanded="false" aria-controls="collapseExample">
                                Bar Chart of Activity Completion
                            </button>
                            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#piechart"
                                    aria-expanded="false" aria-controls="collapseExample">
                                Pie Chart of Activity Completion
                            </button>
                            <button class="btn btn-primary" type="button" data-toggle="collapse"
                                    data-target="#areachart" aria-expanded="false" aria-controls="collapseExample">
