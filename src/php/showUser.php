...
while ($rows = mysqli_fetch_array($res)) {
    ...
    <input id="text" type="text" name="user_name" required placeholder="Required"
           value=" <?php echo $rows['user_name']; ?> "><br><br>
    ...
    <input id="text" type="password" name="password" placeholder="Update Temporary Password"
           value="<<?php echo $rows['password']; ?>"><br><br>
