        ...
        <nav class="navbar navbar-icon-top navbar-expand-lg" style="background-color: #784794;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#">HDipC_IntroToDatabases</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">HDipC_SoftwareDev</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">HDipC_Multimedia</a>
                        </div>
                    </li>
                    <li class="nav-item active">
                ...
                <form class="form-inline my-2 my-lg-0 float-right">
                    <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" style="color: white; ">
                </form>
            </div>
        </nav>
    </body>
